...
#COMING UP WITH ERROR ABOUT ARRANGE COLUMN OF CLASS NULL
...
oxyReportDF$Oxy_CTD_P <- qatDF$Oxy_1
oxyReportDF$Oxy_CTD_S <- qatDF$Oxy_2
oxyReportDF$Oxy_W_Rep1 <- oxygenBottle
oxyReportDF$Oxy_W_Rep2 <- oxygenBottleDuplicate

# Output the Oxygen report.
write.table(oxyReportDF, file = "HUD2012042_Oxygen_Rpt.csv", quote = FALSE, sep = ",", row.names = FALSE, na = "")
...
save.image(file = 'HUD2012042_Prepared_Data.RData')
