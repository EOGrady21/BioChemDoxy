...
write.table(oxyReportDF, file = "HUD99022_Oxygen_Rpt.csv", quote = FALSE, sep = ",", row.names = FALSE, na = "")
...
save.image(file = 'HUD99022_Prepared_Data.RData')
