...
btlLIST(27).desc = {'chlorophyll-a content: fluorometric method of Holm-Hansen, Lorenzen, Holmes and Strickland (1965)';...
      ...
      'chlorophyll-a content: Welschmeyer (1994)';...
   	  ...
   	  'cholorophyll-a content: unknown method'};
...
btlLIST(37).method = {'NO2_01';'NO2_02';'NO2_03';'NO2_99';'NO2_XX'};
...
btlLIST(39).method = {'PO4_01';'PO4_02';'PO4_03';'PO4_99';'PO4_XX'};
...
btlLIST(41).method = {'Si_01';'Si_02';'Si_03';'Si_99';'Si_XX'};
...
btlLIST(48).method = {'NOx_01';'NOx_02';'NOx_03';'NOx_99';'NOx_XX'};
...
btlLIST(71).desc = {'salinity measurement'};
...
btlLIST(77).code = 'TEMP';
btlLIST(77).gf3 = 'TEMP';
btlLIST(77).btl2gf3 = 1;
btlLIST(77).decimal = 4;
btlLIST(77).method = {'TEMP'};
...
btlLIST(79).units = 'none';                             %Variable units in btl-file
...
btlLIST(79).decimal = 2;                                %Number of decimal places
btlLIST(79).method = {'pH_01'};                         %Method number
btlLIST(79).desc = {'pH: calculated in situ value'};    %Method description
...
btlLIST(84).units = 'none';                             %Variable units in btl-file
...
btlLIST(84).decimal = 2;                                %Number of decimal places
...
%btlLIST(19).decimal = 3;
%btlLIST(19).method = {'PSAR'};
%btlLIST(19).desc = {'water column PAR (photosynthetically active radiation): CTD'};%Si variable avec un numéro de méthode (ex: 'ALKY_01'), alors garder le '_' dans le btlLIST.code (ex: 'ALKY_') 
