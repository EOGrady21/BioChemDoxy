...
btlLIST(79).desc = {'pH: calculated in situ value, Strickland & Parsons 1972 (NBS scale)';...
                    'pH: calculated in situ value, Lewis & Wallace 1998 (NBS scale) used for CTD calibration and comparison with old datasets';...
                    'pH: unknown method'};
...
btlLIST(81).desc = {'alkalinity: determination of carbonate, bicarbonate, and free carbon dioxide from pH and alkalinity measures (Strickland and Parsons 1972)'};
...
btlLIST(84).method = {'LBPH_01'};                         %Method number
btlLIST(84).desc = {'pH: laboratory measurement'};      %Method description
...
btlLIST(88).name = 'bottle sample pH';                  %Variable name in btl-file
...
btlLIST(88).method = {'pHT_01'};                 %Method number
btlLIST(88).desc = {'pH: Spectrometer measurement converted to in situ, Lewis & Wallace 1998 (Total scale mol/kg-SW)'};
...
btlLIST(89).method = {'LBPHT_01'};                         %Method number
btlLIST(89).desc = {'pH: laboratory spectrometer measurement, Lewis & Wallace 1998 (Total scale mol/kg-SW)'};      %Method description
...
btlLIST(92).name = 'turbidity,Wetlabs FLNTURT-792';     %Variable name in btl-file
...
btlLIST(92).method = {'TRB_'};                          %Method number
btlLIST(92).desc = {'turbidity: CTD'};                  %Method description
