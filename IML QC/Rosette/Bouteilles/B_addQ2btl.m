...
%Variable names
names_B  = {'TEMP_RT'  ,'SSTP_BK'  ,'PSAL_BS','SSAL_BS','SIGT_0','OXY_0','CHL_0','NO2_0','NO3_0','NOX_0','PO4_0','Si_0' ,'pH_0' ,'ALKY_0','QCFF'};  
names_BQ = {'Q_TEMP_RT','Q_SSTP_BK','Q_PSAL' ,'Q_SSAL' ,'Q_SIGT','Q_OXY','Q_CHL','Q_NO2','Q_NO3','Q_NOX','Q_PO4','Q_Si' ,'Q_pH' ,'Q_ALKY','QCFF'};
names_Q  = {'temp'     ,'temp'     ,'psal'   ,'psal'   ,'sigt'  ,'doxy' ,'cphl' ,'ntri' ,'ntrz' ,'ntrz' ,'phos' ,'slca' ,'phph' ,'alky'  ,'QCFF'};
names_QQ = {'Qtemp'    ,'Qtemp'    ,'Qpsal'  ,'Qpsal'  ,'Qsigt' ,'Qdoxy','Qcphl','Qntri','Qntrz','Qntrz','Qphos','Qslca','Qphph','Qalky' ,'QCFF'};
