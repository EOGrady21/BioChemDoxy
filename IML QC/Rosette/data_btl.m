...
%% feb 2016: added new methods for NH4, N2O and altimeter (but this
%% latter preceeded by %% because usually don't want to transfer this)
%% I think that Caroline recently reworked the whole file to include
%% all the recent pHT codes.


%% February 2019
%% Modified by Emily Chisholm (BIO) to accomodate oxygen data which was pulled from BIOCHEM
%% In units of mmol/m**3. Added code OXYM_01 to represent Winkler measurements recorded in mmol/m**3
%% This script uses conversion factor of 44.66 to translate data to ml/l before QC
...
btlLIST(20).name = 'bottle sample temperature';
btlLIST(20).units = 'deg C';
btlLIST(20).type = 'terrain';
btlLIST(20).code = 'TEMP_';
btlLIST(20).gf3 = 'TEMP';
btlLIST(20).btl2gf3 = 1;
btlLIST(20).decimal = 4;
btlLIST(20).method = {'TEMP_RT';'TEMP_XX'};
btlLIST(20).desc = {'reversing thermometer measurement';'temperature measurement, method unknown'};
...
btlLIST(43).method = {'NH4_01';'NH4_02';'NH4_03';'NH4_04';'NH4_XX'; 'NH4_05'};
btlLIST(43).desc = {'ammonium content: Van Slyke and Hillen (1933)';...
      'ammonium content: EPA (1984)';...
      'ammonium content: Kérouel & Aminot (1997), autoanalyzer with frozen sample';...
      'ammonium content: Kérouel & Aminot (1997), manual method with fresh sample';...
...
btlLIST(75).name = 'quality flag of bottle sample alkalinity';
btlLIST(75).units = '(none)';
btlLIST(75).type = 'labo';
btlLIST(75).code = 'Q_ALKY';
btlLIST(75).gf3 = 'QQQQ';
btlLIST(75).btl2gf3 = 1;
btlLIST(75).decimal = 0;
btlLIST(75).method = {'Q_ALKY'};
btlLIST(75).desc = {'quality flag of bottle sample alkalinity'};

btlLIST(76).name = 'bottle sample adenosine triphosphate';
btlLIST(76).units = 'mg/m**3';
btlLIST(76).type = 'labo';
btlLIST(76).code = 'ATP_';
btlLIST(76).gf3 = 'ATP_';
btlLIST(76).btl2gf3 = 1;
btlLIST(76).decimal = 5;
btlLIST(76).method = {'ATP_01'};
btlLIST(76).desc = {'determination of adenosine triphosphate (ATP) (Strickland and Parsons 1972)'};

btlLIST(77).name = 'CTD fluorescence of CDOM';
btlLIST(77).units = 'mg/m**3';
btlLIST(77).type = 'CTD';
btlLIST(77).code = 'CDOM'; 
btlLIST(77).gf3 = 'CDOM';
btlLIST(77).btl2gf3 = 1;
btlLIST(77).decimal = 3;
btlLIST(77).method = {'CDOM'};
btlLIST(77).desc = {'fluorescence of coloured dissolved organic matter: CTD'};

btlLIST(78).name = 'bottle sample pH';
btlLIST(78).units = 'NBS scale';
btlLIST(78).type = 'labo';
btlLIST(78).code = 'pH_';
btlLIST(78).gf3 = 'PHPH';
btlLIST(78).btl2gf3 = 1;
btlLIST(78).decimal = 4;
btlLIST(78).method = {'pH_01';'pH_02';'pH_XX'};
btlLIST(78).desc = {'pH: mesuré au laboratoire,converti au pH in situ(Strickland&Parsons 1972)(NBS scale)';...
                    'pH: mesuré au laboratoire(Aminot&Chaussepied 1983)/converti au pH in situ(Lewis&Wallace 1998)(NBS scale)';...
                    'pH: unknown method'};

btlLIST(79).name = 'quality flag of bottle sample pH';
btlLIST(79).units = '(none)';
btlLIST(79).type = 'labo';
btlLIST(79).code = 'Q_pH';
btlLIST(79).gf3 = 'QQQQ';
btlLIST(79).btl2gf3 = 1;
btlLIST(79).decimal = 0;
btlLIST(79).method = {'Q_pH'};
btlLIST(79).desc = {'quality flag water pH'};

btlLIST(80).name = 'bottle sample carbonate alkalinity';
btlLIST(80).units = 'mmol/m**3';
btlLIST(80).type = 'labo';
btlLIST(80).code = 'CALK_';
btlLIST(80).gf3 = 'CALK';
btlLIST(80).btl2gf3 = 1;
btlLIST(80).decimal = 0;
btlLIST(80).method = {'CALK_01'};
btlLIST(80).desc = {'alkalinity: determination of carbonate, bicarbonate, and free carbon dioxide from pH and alkalinity measures (Strickland&Parsons 1972)'};

btlLIST(81).name = 'lab temperature for pH calculation';
btlLIST(81).units = 'deg C';
btlLIST(81).type = 'labo';
btlLIST(81).code = 'LABT_';
btlLIST(81).gf3 = 'LABT';
btlLIST(81).btl2gf3 = 1;
btlLIST(81).decimal = 4;
btlLIST(81).method = {'LABT_01'};
btlLIST(81).desc = {'lab temperature for calculation of pH'};

btlLIST(82).name = 'quality flag temperature';
btlLIST(82).units = '(none)';
btlLIST(82).type = 'labo';
btlLIST(82).code = 'Q_TEMP';
btlLIST(82).gf3 = 'QQQQ';
btlLIST(82).btl2gf3 = 1;
btlLIST(82).decimal = 0;
btlLIST(82).method = {'Q_TEMP'};
btlLIST(82).desc = {'quality flag of temperature'};
...
btlLIST(84).type = 'CTD';
btlLIST(84).code = 'PHPH_T';
btlLIST(84).gf3 = 'PHT_';
btlLIST(84).btl2gf3 = 1;
btlLIST(84).decimal = 3;
btlLIST(84).method = {'PHPH_T'};
...
btlLIST(96).method = {'TRB_'};
btlLIST(96).desc = {'turbidity: CTD'};
...
btlLIST(99).name = 'bottle sample nitrous oxide (N2O) content';
btlLIST(99).units = 'nmol/L';
btlLIST(99).type = 'labo';
btlLIST(99).code = 'N2O_';
btlLIST(99).gf3 = 'N2O_';
btlLIST(99).btl2gf3 = 1;
btlLIST(99).decimal = 2;
btlLIST(99).method = {'N2O_01';'N2O_02';'N2O_XX'};               %Method number
btlLIST(99).desc = {'nitrous oxide (N2O) content: Randall et al. (2012)';...
                    'nitrous oxide (N2O) content: unpublished method (used for missions IML-2011-61, IML-2015-41)';...
                    'nitrous oxide (N2O) content: method unknown'};

btlLIST(100).name = 'quality flag of bottle sample N2O';
btlLIST(100).units = '(none)';
btlLIST(100).type = 'labo';
btlLIST(100).code = 'Q_N2O';
btlLIST(100).gf3 = 'QQQQ';
btlLIST(100).btl2gf3 = 1;
btlLIST(100).decimal = 0;
btlLIST(100).method = {'Q_N2O'};
btlLIST(100).desc = {'quality flag of bottle sample nitrous oxide (N2O) content'};

btlLIST(101).name = 'CTD altimètre';
btlLIST(101).units = 'm';
btlLIST(101).type = 'CTD';
btlLIST(101).code = 'ALT_';
btlLIST(101).gf3 = 'ALT_';
btlLIST(101).btl2gf3 = 1;
btlLIST(101).decimal = 0;
btlLIST(101).method = {'UNKN_01'};
btlLIST(101).desc = {'Altimètre CTD'};

btlLIST(102).units = 'mgN/m**3/h';
btlLIST(102).type = 'labo';
btlLIST(102).code = 'NUPT_';
btlLIST(102).gf3 = 'NUPT';
btlLIST(102).btl2gf3 = 1;
btlLIST(102).decimal = 2;
btlLIST(102).method = {'NUPT_01'};
btlLIST(102).desc = {'nitrogen uptake: Fiedler & Proksch 1979, in situ incubations'}; 

btlLIST(103).name = 'bottle sample oxygen';
btlLIST(103).units = 'mmol/m**3';   %original units
btlLIST(103).type = 'labo';
btlLIST(103).code = 'OXYM_';      %new variable code in the BTL_* file
btlLIST(103).gf3 = 'DOXY';
btlLIST(103).btl2gf3 = 1/44.66;     %standard conversion factor
btlLIST(103).decimal = 3;
btlLIST(103).method = {'OXYM_01';'OXYM_02';'OXYM_XX';'OXYM_03'};
btlLIST(103).desc = {'Winkler dissolved oxygen titration method: Carpenter (1965) and Carrit and Carpenter (1966)';...
      'Winkler automated dissolved oxygen titration method: Jones, Zemlyak and Stewart (1992)';...
   	'dissolved oxygen: unknown method';...
    'dissolved oxygen measured by laboratory electrode'};

btlLIST(104).name = 'quality flag of bottle sample oxygen';
btlLIST(104).units = '(none)';
btlLIST(104).type = 'labo';
btlLIST(104).code = 'Q_OXYM';
btlLIST(104).gf3 = 'QQQQ';
btlLIST(104).btl2gf3 = 1/44.66;
btlLIST(104).decimal = 0;
btlLIST(104).method = {'Q_OXYM'};
btlLIST(104).desc = {'quality flag of bottle sample oxygen in mmol/m**3'};
