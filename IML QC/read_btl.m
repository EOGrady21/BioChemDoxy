...
%Modifications:
% Lecture du fichier BTL nom de variable par bloc de 11 caractères. Avant
% lecture des noms de variables séparées par des espaces.
% CL, 15-May-2014
...
for i=3:length(names)
   ...
   if isempty(I)
      disp(['Data ' names{i} ' not stored: no correspondence found in data_cnv'])
   else
      j=j+1;
      switch i
      case 3
