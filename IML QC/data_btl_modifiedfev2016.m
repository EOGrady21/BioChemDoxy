...
%gak! corrected "phophate" spelling error 19 apr 2007
...
btlLIST(79).name = 'bottle sample pH';                  %Variable name in btl-file
btlLIST(79).units = 'NBS scale';                             %Variable units in btl-file
btlLIST(79).type = 'labo';                              %Data type
btlLIST(79).code = 'pH_';                               %Variable code in btl-file (unique)
btlLIST(79).gf3 = 'PHPH';                               %Variable GF3 code
btlLIST(79).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(79).decimal = 4;                                %Number of decimal places
btlLIST(79).method = {'pH_01';'pH_02';'pH_XX'};                 %Method number
...
btlLIST(83).desc = {'pH: CTD'};

% % when the ctd is calibrated to the total scale:
% %%!!! probably not correct!!! code PHPH is defined as NBS scale
% %% need to check with Caro
% btlLIST(83).name = 'CTD pH';
% btlLIST(83).units = 'Total scale';
% btlLIST(83).type = 'CTD';
% btlLIST(83).code = 'PHT_';
% btlLIST(83).gf3 = 'PHT_';
% btlLIST(83).btl2gf3 = 1;
% btlLIST(83).decimal = 3;
% btlLIST(83).method = {'PHT_'};
% btlLIST(83).desc = {'pH: CTD/Calibrated to total scale'};


btlLIST(84).name = 'bottle sample pH, lab measurement'; %Variable name in btl-file
btlLIST(84).units = 'NBS scale';                             %Variable units in btl-file
btlLIST(84).type = 'labo';                              %Data type
btlLIST(84).code = 'LBPH_';                               %Variable code in btl-file (unique)
btlLIST(84).gf3 = 'LBPH';                               %Variable GF3 code
btlLIST(84).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(84).decimal = 4;                                %Number of decimal places
btlLIST(84).method = {'LBPH_01';'LBPH_02'};                 %Method number
btlLIST(84).desc = {'pH: mesuré au laboratoire/potentiometric determination(Strickland&Parsons 1972)/glass electrode calibrated with NBS standards, NOT sw standards';...
...
btlLIST(85).name = 'bottle sample primary production, daily rate';
btlLIST(85).units = 'mgC/m**3/d';
btlLIST(85).type = 'labo';
btlLIST(85).code = 'PPRD_';
btlLIST(85).gf3 = 'PPRD';
btlLIST(85).btl2gf3 = 1;
btlLIST(85).decimal = 2;
btlLIST(85).method = {'PPRD_01'};
btlLIST(85).desc = {'primary production: 24h simulated in situ incubations; JGOFS core measurements (JGOFS Report No. 19)'};

btlLIST(86).name = 'Lab sigma-t';
btlLIST(86).units = 'kg/m**3';
btlLIST(86).type = 'labo';
btlLIST(86).code = 'SIGT_00';
btlLIST(86).gf3 = 'SIGT';
btlLIST(86).btl2gf3 = 1;
btlLIST(86).decimal = 2;
btlLIST(86).method = {'SIGT_00'};
btlLIST(86).desc = {'sigma-t: calculated from autosal and temp data'};

btlLIST(87).name = 'quality flag of lab sigma-t';
btlLIST(87).units = '(none)';
btlLIST(87).type = 'labo';
btlLIST(87).code = 'Q_SIGT';
btlLIST(87).gf3 = 'QQQQ';
btlLIST(87).btl2gf3 = 1;
btlLIST(87).decimal = 0;
btlLIST(87).method = {'Q_SIGT'};
btlLIST(87).desc = {'quality flag sigma-t calculated from t,s'};

btlLIST(88).name = 'bottle sample pH, in situ calc';    %Variable name in btl-file
btlLIST(88).units = 'Total scale';                      %Variable units in btl-file
btlLIST(88).type = 'labo';                              %Data type
btlLIST(88).code = 'pHT_';                              %Variable code in btl-file (unique)
btlLIST(88).gf3 = 'PHT_';                               %Variable GF3 code
btlLIST(88).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(88).decimal = 4;                                %Number of decimal places
btlLIST(88).method = {'pHT_01';'pHT_02'};               %Method number
btlLIST(88).desc = {'pH: mesuré au laboratoire/spectrophotometric determination(SOP6b in Dickson et al. 2007)/converti au pH in situ selon Lewis&Wallace 1998'...
...
btlLIST(89).name = 'bottle sample pH, lab measurement'; %Variable name in btl-file
btlLIST(89).units = 'Total scale';                      %Variable units in btl-file
btlLIST(89).type = 'labo';                              %Data type
btlLIST(89).code = 'LBPHT_';                            %Variable code in btl-file (unique)
btlLIST(89).gf3 = 'LPHT';                               %Variable GF3 code
btlLIST(89).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(89).decimal = 4;                                %Number of decimal places
btlLIST(89).method = {'LBPHT_01';'LBPHT_02'};           %Method number
btlLIST(89).desc = {'pH: mesuré au laboratoire/spectrophotometric determination(SOP6b in Dickson et al. 2007)';...      %Method description
                    'pH: mesuré au laboratoire/spectrophotometric determination(SOP6b in Dickson et al. 2007) BUT on preserved sample'};

btlLIST(90).name = 'bottle sample NOx uptake'; %Variable name in btl-file
btlLIST(90).units = 'mmolN/m**3/h';                             %Variable units in btl-file
btlLIST(90).type = 'labo';                              %Data type
btlLIST(90).code = 'UNO3_';                               %Variable code in btl-file (unique)
btlLIST(90).gf3 = 'UNO3';                               %Variable GF3 code
btlLIST(90).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(90).decimal = 4;                                %Number of decimal places
btlLIST(90).method = {'UNO3_01'};                         %Method number
btlLIST(90).desc = {'Nitrate uptake, determination of new production, Vézina 1994'};      %Method description

btlLIST(91).name = 'bottle sample NH4 uptake'; %Variable name in btl-file
btlLIST(91).units = 'mmolN/m**3/h';                             %Variable units in btl-file
btlLIST(91).type = 'labo';                              %Data type
btlLIST(91).code = 'UNH4_';                               %Variable code in btl-file (unique)
btlLIST(91).gf3 = 'UNH4';                               %Variable GF3 code
btlLIST(91).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(91).decimal = 4;                                %Number of decimal places
btlLIST(91).method = {'UNH4_01'};                         %Method number
btlLIST(91).desc = {'Ammonium uptake, determination of regenerated production, Vézina 1994'};      %Method description

btlLIST(92).name = 'CTD turbidity';                     %Variable name in btl-file
btlLIST(92).units = 'NTU';                              %Variable units in btl-file
btlLIST(92).type = 'CTD';                               %Data type
btlLIST(92).code = 'TRB_';                              %Variable code in btl-file (unique)
btlLIST(92).gf3 = 'TRB_';                               %Variable GF3 code
btlLIST(92).btl2gf3 = 1;                                %Conversion factor*btl=GF3 (usually 1)
btlLIST(92).decimal = 3;                                %Number of decimal places
btlLIST(92).method = {'TRB_01'};                        %Method number
btlLIST(92).desc = {'CTD turbidity, WET Labs ECO'};     %Method description


% %%% Q flag for variable pHT (btlLIST #88)
btlLIST(93).name = 'quality flag of bottle sample in situ pH';
btlLIST(93).units = '(none)';
btlLIST(93).type = 'labo';
btlLIST(93).code = 'Q_pHT';
btlLIST(93).gf3 = 'QQQQ';
btlLIST(93).btl2gf3 = 1;
btlLIST(93).decimal = 0;
btlLIST(93).method = {'Q_pHT'};
btlLIST(93).desc = {'quality flag in situ pH'};
% 
% %%% Q flag for variable LBPHT (btlLIST #89)
btlLIST(94).name = 'quality flag of bottle sample pH, lab measure';
btlLIST(94).units = '(none)';
btlLIST(94).type = 'labo';
btlLIST(94).code = 'Q_LBPHT';
btlLIST(94).gf3 = 'QQQQ';
btlLIST(94).btl2gf3 = 1;
btlLIST(94).decimal = 0;
btlLIST(94).method = {'Q_LBPHT'};
btlLIST(94).desc = {'quality flag pH, lab measure'};

btlLIST(95).name = 'bottle sample alkalinity';
btlLIST(95).units = 'umol/kg**1';
btlLIST(95).type = 'labo';
btlLIST(95).code = 'ALKW_';
btlLIST(95).gf3 = 'ALKW';
...
btlLIST(95).decimal = 0;
btlLIST(95).method = {'ALKW_01'};
btlLIST(95).desc = {'alkalinity: Determination of total alkalinity in seawater using an open-cell titration (SOP 3b in Dickson et al. 2007)'};

btlLIST(96).name = 'bottle sample total inorganic carbon';
btlLIST(96).units = 'umol/kg**1';
btlLIST(96).type = 'labo';
btlLIST(96).code = 'TICW_';
btlLIST(96).gf3 = 'TICW';
btlLIST(96).btl2gf3 = 1;
btlLIST(96).decimal = 0;
btlLIST(96).method = {'TICW_01'};
btlLIST(96).desc = {'TIC: Determination of total dissolved inorganic carbon in seawater (SOP 2 in Dickson et al. 2007)'};

btlLIST(97).name = 'CTD altimètre';
btlLIST(97).units = 'm';
btlLIST(97).type = 'CTD';
btlLIST(97).code = 'AltM';
btlLIST(97).gf3 = 'UNKN';
btlLIST(97).btl2gf3 = 1;
btlLIST(97).decimal = 0;
btlLIST(97).method = {'UNKN_01'};
btlLIST(97).desc = {'Altimètre CTD'};
