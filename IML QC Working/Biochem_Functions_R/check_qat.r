...
check_qat = function(filename){
  ...
  qat_header$date_time=as.POSIXlt(qat$date_time) # change back to POSIXlt
  ...
  tests=which(qat_header$id==999999 | qat$id<100)
