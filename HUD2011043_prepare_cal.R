...
oxyDF <- Dat$HUD11043          #sub list for each cruise
...
write.table(oxyReportDF, file = "HUD2011043_Oxygen_Rpt.csv", quote = FALSE, sep = ",", row.names = FALSE, na = "")
...
save.image(file = 'HUD2011043_Prepared_Data.RData')

cat('The prepared data has been saved to the file HUD2011043_Prepared_Data.R')
